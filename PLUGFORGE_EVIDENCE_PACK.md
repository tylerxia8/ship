...
Generated: `2026-06-03T23:39:10.313Z`
...
| --- | --- | --- | --- |
| `/health` | Yes | 200 | 236ms |
| `/api/v1/openapi.json` | Yes | 200 | 228ms |
| `/api/v1/scopes` | Yes | 200 | 180ms |
| `/api/v1/webhooks/events` | Yes | 200 | 181ms |
...
```text
  ...
  "checked_at": "2026-06-03T23:38:58.973Z",
  "results": [
    {
      "name": "GET /health",
      "path": "/health",
