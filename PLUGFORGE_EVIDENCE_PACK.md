...
Generated: `2026-06-03T19:04:59.078Z`
...
| --- | --- | --- | --- |
| `/health` | Yes | 200 | 313ms |
| `/api/v1/openapi.json` | Yes | 200 | 177ms |
| `/api/v1/scopes` | Yes | 200 | 259ms |
| `/api/v1/webhooks/events` | Yes | 200 | 215ms |
...
```text
  ...
  "checked_at": "2026-06-03T19:04:58.792Z",
  "results": [
    {
      "name": "GET /health",
      "path": "/health",
