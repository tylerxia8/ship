...
- **Scanned at:** 2026-05-22T00:23:15.816Z
- **Probe version:** 1.0.0
...
### 🟢 Login endpoint rate-limited after 1 failed attempts

- **ID:** `ratelimit-login-active`
- **Severity:** ok

POST /api/auth/login returned 429 on attempt #1. Brute-force protection is active. The skipSuccessfulRequests:true means only failed attempts count.

**Evidence:**
```
{
  "rateLimitedAtAttempt": 1
}
```
