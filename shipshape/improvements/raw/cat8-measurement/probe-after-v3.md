...
- **Scanned at:** 2026-05-22T01:42:28.710Z
- **Probe version:** 1.0.0
...
### 🟢 Login endpoint rate-limited after 3 failed attempts

- **ID:** `ratelimit-login-active`
- **Severity:** ok

POST /api/auth/login returned 429 on attempt #3. Brute-force protection is active. The skipSuccessfulRequests:true means only failed attempts count.

**Evidence:**
```
{
  "rateLimitedAtAttempt": 3
}
```
...
[
  ...
  {
    "probe": "GET /api/<unknown>",
    "status": 404,
    "body": "{\"success\":false,\"error\":{\"code\":\"NOT_FOUND\",\"message\":\"No route for GET /api/this-route-does-not-exist\"}}"
  },
  {
    "probe": "GET /api/documents/not-a-uuid",
    "status": 401,
