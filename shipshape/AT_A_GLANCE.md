...
| Production verification | — | **All Cat 8 protections verified live** on ship-henna.vercel.app + ship-api-76ez.onrender.com via [security/verify-prod.mjs](security/verify-prod.mjs); 12/12 checks `ok` (latest run 2026-05-22T20:25Z) |
...
| 7 | Deployed application | ✅ Live on Vercel + Render + Neon — web: [ship-henna.vercel.app](https://ship-henna.vercel.app) · api: `ship-api-76ez.onrender.com`. Production Cat 8 verification: [security/raw-prod/verification.md](security/raw-prod/verification.md) (12/12 ok on 2026-05-22). Codified as Terraform at [../terraform/render-vercel-neon/](../terraform/render-vercel-neon/) (`apply`-verified — [terraform-apply-evidence.md](security/raw-prod/terraform-apply-evidence.md)) and as a production-mirror compose at [../docker-compose.prod-mirror.yml](../docker-compose.prod-mirror.yml) (`up --build`-verified — [docker-prod-mirror-smoke-2026-05-22.md](security/raw-prod/docker-prod-mirror-smoke-2026-05-22.md)). |
