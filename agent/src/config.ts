...
export const config = {
  ...
  ship: {
    ...
    agentClientId: optional('SHIP_AGENT_CLIENT_ID', ''),
    agentClientSecret: optional('SHIP_AGENT_CLIENT_SECRET', ''),
    agentClientScope: optional('SHIP_AGENT_CLIENT_SCOPE', 'documents:read'),
